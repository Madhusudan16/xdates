            ...
            <div class="row">
                <div class="col-md-11">
                    <div class="left_section">
                        ...
                        <form class="form-horizontal" autocomplete="off" role="form" method="POST" action="{{ url('/register') }}">
                        	{!! csrf_field() !!}
                              ...
                              <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    @if ($errors->has('password'))
                                        <span class="help-block">
                                            <sapn>{{ $errors->first('password') }}</span>
                                        </span>
                                    @endif
                                </div>
                              </div>
                            ...
                            <div class="form-group{{ $errors->has('promotion_code') ? ' has-error' : '' }}">
                                <label for="promotionCode" class="col-sm-5 control-label">Promotion Code<span class="option">(optional)</span></label>
                                <div class="col-sm-7">
                                    <span class="border-span"><input type="text" name="promotion_code" class="form-control" id="promotion_code"></span>
                                    @if ($errors->has('promotion_code'))
                                        <span class="help-block">
                                            <span>{{ $errors->first('promotion_code') }}</span>
                                        </span>
                                    @endif
                                </div>
                            </div>
                        ...
                        <p>By clicking the "Sign up" button, you accept our <a href="{{url('/term-of-service')}}" target="_blank"><u>Terms of Service</u></a> and <a  href="{{url('/privacy-policy')}}" target="_blank"><u>Privacy Policy</u></a>.</p>
                    </div>
                </div>
            </div>
        </div>
