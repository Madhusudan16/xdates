        ...
        <div class="box_bg">
            ...
            <div class="row">
                <div class="col-md-offset-3 col-md-6 col-sm-6 col-sm-offset-2 col-xs-10 col-xs-offset-1">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/password/reset') }}">
                        	...
                        	<input type="hidden" name="token" value="{{ $token }}">
                        	 ...
                        	 <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
	                            ...
	                            <div class="col-sm-7">
	                                <span class="border-span"><input type="email" readonly="readonly" class="form-control" name="email" id="email" value="{{ $email or old('email') }}"></span>
	                                @if ($errors->has('email'))
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    <span class="border-span"><input type="password" name="password" maxlength="20" class="form-control" id="password"></span>
                    ...
                    <div class="col-md-offset-0 col-sm-offset-0 col-md-3 col-sm-4 col-xs-10  col-xs-offset-1 padding-left-none password_intro">
                    <div class="left_text">
