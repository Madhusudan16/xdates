    ...
    if($( "#addUserForm" ).valid()){
	    ...
	    $.ajax({
	        ...
	        success: function (data) { 
	          ...
	          $("input[name=email]").val("");
	          $('#add_user').modal('hide');
	          $('.admin-tab a[href="#activated"]').tab('show');
	...
	var id = $('#userdeact').val();
       ...
       success: function (data) {        
         // $('#' + id).parent().parent().remove();
          ...
          $('.loader').show(); 
          reloadUsersData();
          $('.admin-tab a[href="#deactivated"]').tab('show');
       },
        error: function (jqXHR, exception) {
        	$('#user_deactivate_btn').removeClass('disabled').text('Confirm');
        }
...
$(document).ready(function(){
	...
	}, "This field should have first and last name with space.");
	...
	$( "#editUserForm" ).validate({
	    ...
	    highlight: function(element) {
		  ...
		  messages: {
			...
			account_typen : "Please select account type.",
		  }
	});
})
